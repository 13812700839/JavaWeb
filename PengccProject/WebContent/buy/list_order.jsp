...
<%@ page import="com.digitalweb.impl.OrderDaoImpl" %>
<%@ page import="com.digitalweb.model.OrderDetail" %>
<%@ page import="com.digitalweb.model.Order" %>
                ...
                <table>
                    ...
                    <tr>
                        <th scope="col" colspan="4">
                            订单编号：<span style="font-size: 12px;color: blue;"><%=o.getId()%></span>&nbsp;
                            状态：<span style="font-size: 12px;color: blue;"><%=o.getStatus()%></span>&nbsp;
                            订单时间：<span style="font-size: 12px;color: blue;"><%=o.getOrdertime()%></span>&nbsp;
                            收货人：<span style="font-size: 12px;color: blue;"><%=user.getRealName()%></span>&nbsp;
                            <%
